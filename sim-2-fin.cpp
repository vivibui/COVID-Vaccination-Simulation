...
class Population
{
    ...
    public: 
		...
		double  percentage_vaccinated = 0.10;  
...
int main() 
{
    ...
    cout << left << setw(allWidth) << setfill(separator) << "Max infected for High"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max infected for Medium"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max infected for Low"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max day I for High";  
    cout << left << setw(allWidth) << setfill(separator) << "Max day I for Medium";   
    cout << left << setw(allWidth) << setfill(separator) << "Max day I for Low" << endl;    
    ...
    cout << left << setw(allWidth) << setfill(separator) << maxdayI_L << endl; 
