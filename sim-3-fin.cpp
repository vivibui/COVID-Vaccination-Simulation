...
class Population
{
    ...
    public: 
		...
		double  percentage_vaccinated = 0;  
...
int main() 
{
    ...
    cout << left << setw(allWidth) << setfill(separator) << "Max I - H"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max I - M"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max I - L"; 
    cout << left << setw(allWidth) << setfill(separator) << "Max Day I - H";  
    cout << left << setw(allWidth) << setfill(separator) << "Max Day I - M";   
    cout << left << setw(allWidth) << setfill(separator) << "Max Day I - L";
	cout << left << setw(allWidth) << setfill(separator) << "Death - H"; 
    cout << left << setw(allWidth) << setfill(separator) << "Death - M"; 
    cout << left << setw(allWidth) << setfill(separator) << "Death - L" << endl;    
    ...
    {	
		...
		int max_infected_H = 0;
		int max_infected_M = 0;
		int max_infected_L = 0;
		...
		while (population.CountSick() > 0) 
		{
			...
			int count_infected_H = countInfectedByGroup("high", population);
			int count_infected_M = countInfectedByGroup("medium", population);
			int count_infected_L = countInfectedByGroup("low", population);

			// Max infected - High 
			if (count_infected_H > max_infected_H) 
			{ 
				max_infected_H = count_infected_H; 
				maxdayI_H = day_count; 
			}

			// Max infected - Medium
			if (count_infected_M > max_infected_M) 
			{ 
				max_infected_M = count_infected_M; 
				maxdayI_M = day_count; 
			}

			// Max infected - Low
			if (count_infected_L > max_infected_L) 
			{ 
				max_infected_L = count_infected_L; 
				maxdayI_L = day_count; 
			}
		...
		cout << left << setw(dayWidth) << setfill(separator) << day_count;
		cout << left << setw(allWidth) << setfill(separator) << max_infected_H; 
		cout << left << setw(allWidth) << setfill(separator) << max_infected_M; 
		cout << left << setw(allWidth) << setfill(separator) << max_infected_L; 
		cout << left << setw(allWidth) << setfill(separator) << maxdayI_H;
		cout << left << setw(allWidth) << setfill(separator) << maxdayI_M;
		cout << left << setw(allWidth) << setfill(separator) << maxdayI_L;
		cout << left << setw(allWidth) << setfill(separator) << countDeceasedByGroup("high", population); 
		cout << left << setw(allWidth) << setfill(separator) << countDeceasedByGroup("medium", population);
		cout << left << setw(allWidth) << setfill(separator) << countDeceasedByGroup("low", population) << endl; 
